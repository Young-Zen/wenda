...
public class JedisAdapter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        pool=new JedisPool("redis://root:123456@localhost:6379/10");
    }
    ...
    /*public static void main(String[] argv){
        Jedis jedis=new Jedis("redis://root:123456@localhost:6379/9");
        *//*Jedis jedis=new Jedis("localhost",6379);
        ...
        jedis.hset(userKey,"phone","1234567890");
        ...
        jedis.hsetnx(userKey,"name","young");
        ...
        *//*JedisPool pool=new JedisPool("redis://root:123456@localhost:6379/9");
        for (int i=0;i<100;i++){
